...
- [ ] If music is enabled, it comes from the project's supplied music folder, uses the recorded excerpt offset, has platform/region evidence, and ducks under speech/source audio.
