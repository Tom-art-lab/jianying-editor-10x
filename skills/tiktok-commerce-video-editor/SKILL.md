...
- The shopping arrow must be a clean standalone shape: no faint rectangle, translucent box, bounding panel, halo block, or other rectangular background behind it.
...
- Keep music clearly below all speech and useful source sound; prioritize intelligibility over musical impact. Verify the spoken words remain immediately understandable on phone speakers, and lower or duck the music again if there is any masking.
